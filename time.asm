...
int main (int argc,char *argv[])
{
  ...
  int status, a, b;
  pid = fork();
  15:	e8 9f 02 00 00       	call   2b9 <fork>
  if(pid == 0){
  1a:	85 c0                	test   %eax,%eax
  1c:	75 25                	jne    43 <main+0x43>
      exec(argv[1], argv);
  1e:	52                   	push   %edx
  1f:	52                   	push   %edx
  20:	53                   	push   %ebx
  21:	ff 73 04             	pushl  0x4(%ebx)
  24:	e8 d0 02 00 00       	call   2f9 <exec>
      printf(1, "exec %s failed\n", argv[1]);
  29:	83 c4 0c             	add    $0xc,%esp
  2c:	ff 73 04             	pushl  0x4(%ebx)
  2f:	68 b8 07 00 00       	push   $0x7b8
  34:	6a 01                	push   $0x1
  ...
  exit();
  3e:	e8 7e 02 00 00       	call   2c1 <exit>
      status = waitx(&a, &b);
  43:	50                   	push   %eax
  44:	50                   	push   %eax
  45:	8d 45 f4             	lea    -0xc(%ebp),%eax
  48:	50                   	push   %eax
  49:	8d 45 f0             	lea    -0x10(%ebp),%eax
  4c:	50                   	push   %eax
  4d:	e8 0f 03 00 00       	call   361 <waitx>
      printf(1, "Wait Time = %d\n Run Time = %d with PID = %d \n", a, b,status);
  52:	89 04 24             	mov    %eax,(%esp)
  55:	ff 75 f4             	pushl  -0xc(%ebp)
  58:	ff 75 f0             	pushl  -0x10(%ebp)
  5b:	68 c8 07 00 00       	push   $0x7c8
  60:	6a 01                	push   $0x1
  62:	e8 e9 03 00 00       	call   450 <printf>
  67:	83 c4 20             	add    $0x20,%esp
  6a:	eb d2                	jmp    3e <main+0x3e>
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 396:	89 d3                	mov    %edx,%ebx
{
 ...
 3d9:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb f8 07 00 00       	mov    $0x7f8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
 ...
 764:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 767:	89 15 ac 0a 00 00    	mov    %edx,0xaac
}
