...
main(int argc, char *argv[])
{
  ...
  7f:	50                   	push   %eax
  80:	ff 33                	pushl  (%ebx)
  82:	68 a8 0a 00 00       	push   $0xaa8
  87:	6a 01                	push   $0x1
  89:	e8 92 06 00 00       	call   720 <printf>
      exit();
  ...
  98:	51                   	push   %ecx
  99:	51                   	push   %ecx
  9a:	68 88 0a 00 00       	push   $0xa88
  9f:	6a 02                	push   $0x2
  a1:	e8 7a 06 00 00       	call   720 <printf>
    exit();
...
free(void *ap)
{
 ...
 8f1:	a1 80 0e 00 00       	mov    0xe80,%eax
{
...
malloc(uint nbytes)
{
 ...
 989:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 98c:	8b 3d 80 0e 00 00    	mov    0xe80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a02:	e8 e9 fe ff ff       	call   8f0 <free>
  return freep;
 a07:	8b 15 80 0e 00 00    	mov    0xe80,%edx
 ...
 a34:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a37:	89 15 80 0e 00 00    	mov    %edx,0xe80
}
