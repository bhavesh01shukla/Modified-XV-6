...
int main(int argc, char *argv[])
{
  ...
  11:	83 ec 38             	sub    $0x38,%esp
    ...
    int w,r,ret,p[10];
    if(fork()==0)
  14:	e8 30 03 00 00       	call   349 <fork>
  19:	85 c0                	test   %eax,%eax
  1b:	75 7e                	jne    9b <main+0x9b>
  1d:	89 c3                	mov    %eax,%ebx
  1f:	8d 75 c0             	lea    -0x40(%ebp),%esi
  22:	8d 7d cc             	lea    -0x34(%ebp),%edi
    {
        for(int i=0;i<3;i++)
        {
            p[i]=fork();
  25:	e8 1f 03 00 00       	call   349 <fork>
  2a:	89 06                	mov    %eax,(%esi)
            if(p[i]==0)
  2c:	85 c0                	test   %eax,%eax
  2e:	0f 84 91 00 00 00    	je     c5 <main+0xc5>
  34:	83 c6 04             	add    $0x4,%esi
        for(int i=0;i<3;i++)
  37:	39 fe                	cmp    %edi,%esi
  39:	75 ea                	jne    25 <main+0x25>
            }
        }
        for(int i=0;i<3;i++)
        {
  ...
  3b:	bf 40 00 00 00       	mov    $0x40,%edi
            printf(1,"proc %d.... pid %d \n",i,p[i]);
  40:	8b 74 9d c0          	mov    -0x40(%ebp,%ebx,4),%esi
  44:	56                   	push   %esi
  45:	53                   	push   %ebx
  46:	68 48 08 00 00       	push   $0x848
  4b:	6a 01                	push   $0x1
  ...
  56:	29 d8                	sub    %ebx,%eax
        for(int i=0;i<3;i++)
  58:	83 c3 01             	add    $0x1,%ebx
            set_priority(p[i],64-i);
  5b:	50                   	push   %eax
  5c:	56                   	push   %esi
  5d:	e8 9f 03 00 00       	call   401 <set_priority>
        for(int i=0;i<3;i++)
  62:	83 c4 10             	add    $0x10,%esp
  65:	83 fb 03             	cmp    $0x3,%ebx
  68:	75 d6                	jne    40 <main+0x40>
  6a:	8d 7d bc             	lea    -0x44(%ebp),%edi
  6d:	8d 75 b8             	lea    -0x48(%ebp),%esi
        }
        for(int i=0; i<3;i++)
        {
            ret=waitx(&w,&r);
  ...
  73:	57                   	push   %edi
  74:	56                   	push   %esi
  75:	e8 77 03 00 00       	call   3f1 <waitx>
            printf(1,"pid-%d rtime-%d wtime-%d\n",ret,r,w);
  7a:	5a                   	pop    %edx
  7b:	ff 75 b8             	pushl  -0x48(%ebp)
  7e:	ff 75 bc             	pushl  -0x44(%ebp)
  81:	50                   	push   %eax
  82:	68 5d 08 00 00       	push   $0x85d
  87:	6a 01                	push   $0x1
  89:	e8 52 04 00 00       	call   4e0 <printf>
        for(int i=0; i<3;i++)
  8e:	83 c4 20             	add    $0x20,%esp
  91:	83 eb 01             	sub    $0x1,%ebx
  94:	75 da                	jne    70 <main+0x70>
        }
        exit();
  96:	e8 b6 02 00 00       	call   351 <exit>
    }
    else
    {
        ret=waitx(&w,&r);
  9b:	50                   	push   %eax
  9c:	50                   	push   %eax
  9d:	8d 45 bc             	lea    -0x44(%ebp),%eax
  a0:	50                   	push   %eax
  a1:	8d 45 b8             	lea    -0x48(%ebp),%eax
  a4:	50                   	push   %eax
  a5:	e8 47 03 00 00       	call   3f1 <waitx>
        printf(1,"time=%d\n",w+r);
  aa:	83 c4 0c             	add    $0xc,%esp
  ad:	8b 45 bc             	mov    -0x44(%ebp),%eax
  b0:	03 45 b8             	add    -0x48(%ebp),%eax
  b3:	50                   	push   %eax
  b4:	68 77 08 00 00       	push   $0x877
  b9:	6a 01                	push   $0x1
  bb:	e8 20 04 00 00       	call   4e0 <printf>
        exit();
  c0:	e8 8c 02 00 00       	call   351 <exit>
  c5:	bb 01 e1 f5 05       	mov    $0x5f5e101,%ebx
  ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
                    printf(1,"");
  d0:	83 ec 08             	sub    $0x8,%esp
  d3:	68 5c 08 00 00       	push   $0x85c
  d8:	6a 01                	push   $0x1
  da:	e8 01 04 00 00       	call   4e0 <printf>
                for(int i=0;i<=100000000;i++)
  df:	83 c4 10             	add    $0x10,%esp
  e2:	83 eb 01             	sub    $0x1,%ebx
  e5:	75 e9                	jne    d0 <main+0xd0>
                 sleep(1000);
  e7:	83 ec 0c             	sub    $0xc,%esp
  ea:	68 e8 03 00 00       	push   $0x3e8
  ef:	e8 ed 02 00 00       	call   3e1 <sleep>
                exit();
  f4:	e8 58 02 00 00       	call   351 <exit>
  f9:	66 90                	xchg   %ax,%ax
  fb:	66 90                	xchg   %ax,%ax
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
...
strcmp(const char *p, const char *q)
{
 ...
 138:	8b 75 0c             	mov    0xc(%ebp),%esi
  while(*p && *p == *q)
 13b:	0f b6 13             	movzbl (%ebx),%edx
 13e:	0f b6 0e             	movzbl (%esi),%ecx
 141:	84 d2                	test   %dl,%dl
 143:	74 1e                	je     163 <strcmp+0x33>
 145:	b8 01 00 00 00       	mov    $0x1,%eax
 14a:	38 ca                	cmp    %cl,%dl
 14c:	74 09                	je     157 <strcmp+0x27>
 14e:	eb 20                	jmp    170 <strcmp+0x40>
 150:	83 c0 01             	add    $0x1,%eax
 153:	38 ca                	cmp    %cl,%dl
 155:	75 19                	jne    170 <strcmp+0x40>
 157:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
 15b:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
 15f:	84 d2                	test   %dl,%dl
 161:	75 ed                	jne    150 <strcmp+0x20>
 ...
 166:	5e                   	pop    %esi
  return (uchar)*p - (uchar)*q;
 167:	29 c8                	sub    %ecx,%eax
}
 169:	5d                   	pop    %ebp
 16a:	c3                   	ret    
 16b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 16f:	90                   	nop
 170:	0f b6 c2             	movzbl %dl,%eax
 173:	5b                   	pop    %ebx
 174:	5e                   	pop    %esi
  return (uchar)*p - (uchar)*q;
 175:	29 c8                	sub    %ecx,%eax
}
 177:	5d                   	pop    %ebp
 178:	c3                   	ret    
 ...
 215:	31 f6                	xor    %esi,%esi
{
 ...
 230:	50                   	push   %eax
 231:	6a 00                	push   $0x0
 233:	e8 31 01 00 00       	call   369 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 29d:	e8 ef 00 00 00       	call   391 <open>
  if(fd < 0)
 ...
 2b1:	50                   	push   %eax
 2b2:	e8 f2 00 00 00       	call   3a9 <fstat>
  close(fd);
 2b7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ba:	89 c6                	mov    %eax,%esi
  close(fd);
 2bc:	e8 b8 00 00 00       	call   379 <close>
  return r;
 ...
 426:	89 d3                	mov    %edx,%ebx
{
 ...
 4ae:	56                   	push   %esi
 4af:	57                   	push   %edi
 4b0:	e8 bc fe ff ff       	call   371 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 529:	e8 43 fe ff ff       	call   371 <write>
 ...
 58a:	e8 e2 fd ff ff       	call   371 <write>
        putc(fd, c);
      } else {
 ...
 59e:	e8 ce fd ff ff       	call   371 <write>
  for(i = 0; fmt[i]; i++){
 ...
 611:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 614:	e8 58 fd ff ff       	call   371 <write>
        ap++;
 ...
 68b:	57                   	push   %edi
 68c:	53                   	push   %ebx
 68d:	e8 df fc ff ff       	call   371 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 6d6:	73 10                	jae    6e8 <free+0x38>
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 707:	5e                   	pop    %esi
 708:	5f                   	pop    %edi
 709:	5d                   	pop    %ebp
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 3c 0b 00 00       	mov    %eax,0xb3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 799:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
 ...
 7ab:	e8 29 fc ff ff       	call   3d9 <sbrk>
  if(p == (char*)-1)
 ...
 7c2:	e8 e9 fe ff ff       	call   6b0 <free>
  return freep;
 7c7:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
 ...
 7f4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
}
 ...
 80f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 3c 0b 00 00 40 	movl   $0xb40,0xb3c
 817:	0b 00 00 
    base.s.size = 0;
 81a:	bf 40 0b 00 00       	mov    $0xb40,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 826:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 832:	00 00 00 
    if(p->s.size >= nunits){
