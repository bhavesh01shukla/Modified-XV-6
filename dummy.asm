  ...
  19:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  2a:	e8 82 03 00 00       	call   3b1 <getpid>
  2f:	56                   	push   %esi
  for ( k = 0; k < n; k++ ) {
  30:	83 c3 01             	add    $0x1,%ebx
      printf(1, "Parent %d creating child  %d\n", getpid(), id );
  33:	50                   	push   %eax
  34:	68 3c 08 00 00       	push   $0x83c
  39:	6a 01                	push   $0x1
  3b:	e8 80 04 00 00       	call   4c0 <printf>
      wait ();
  40:	e8 f4 02 00 00       	call   339 <wait>
  45:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  48:	39 fb                	cmp    %edi,%ebx
  4a:	7d 34                	jge    80 <main+0x80>
    id = fork ();
  4c:	e8 d8 02 00 00       	call   329 <fork>
  51:	89 c6                	mov    %eax,%esi
    if ( id < 0 ) {
  53:	85 c0                	test   %eax,%eax
  55:	79 d1                	jns    28 <main+0x28>
      printf(1, "%d failed in fork!\n", getpid() );
  57:	e8 55 03 00 00       	call   3b1 <getpid>
  5c:	83 ec 04             	sub    $0x4,%esp
  for ( k = 0; k < n; k++ ) {
  5f:	83 c3 01             	add    $0x1,%ebx
      printf(1, "%d failed in fork!\n", getpid() );
  62:	50                   	push   %eax
  63:	68 28 08 00 00       	push   $0x828
  68:	6a 01                	push   $0x1
  ...
  exit();
  80:	e8 ac 02 00 00       	call   331 <exit>
    n = atoi ( argv[1] ); //from command line
  ...
  a1:	e8 0b 03 00 00       	call   3b1 <getpid>
  a6:	52                   	push   %edx
  a7:	50                   	push   %eax
  a8:	68 5a 08 00 00       	push   $0x85a
  ad:	6a 01                	push   $0x1
  af:	e8 0c 04 00 00       	call   4c0 <printf>
  b4:	83 c4 10             	add    $0x10,%esp
      for ( z = 0; z < 8000000.0; z += 0.01 )
  b7:	d9 ee                	fldz   
  b9:	dd 05 70 08 00 00    	fldl   0x870
  bf:	90                   	nop
  c0:	dc c1                	fadd   %st,%st(1)
  c2:	d9 05 78 08 00 00    	flds   0x878
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 7c 08 00 00       	mov    $0x87c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 3c 0b 00 00       	mov    %eax,0xb3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
 ...
 7d4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
}
 ...
 7ef:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 3c 0b 00 00 40 	movl   $0xb40,0xb3c
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 40 0b 00 00       	mov    $0xb40,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 812:	00 00 00 
    if(p->s.size >= nunits){
