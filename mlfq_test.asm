...
int main(void)
{
  ...
  10:	83 ec 3c             	sub    $0x3c,%esp
    ...
    {
        int pid = fork();
  13:	e8 b1 02 00 00       	call   2c9 <fork>
  18:	89 c3                	mov    %eax,%ebx

        if (pid == 0)
  1a:	85 c0                	test   %eax,%eax
  1c:	74 1e                	je     3c <main+0x3c>
        int pid = fork();
  1e:	e8 a6 02 00 00       	call   2c9 <fork>
        if (pid == 0)
  23:	85 c0                	test   %eax,%eax
  25:	74 10                	je     37 <main+0x37>
        int pid = fork();
  27:	e8 9d 02 00 00       	call   2c9 <fork>
    for (int i = 0; i < 3; i++)
  2c:	bb 02 00 00 00       	mov    $0x2,%ebx
        if (pid == 0)
  31:	85 c0                	test   %eax,%eax
  33:	74 07                	je     3c <main+0x3c>
                sleep(100);
            }
        }
    }
    while (1)
        ;
  35:	eb fe                	jmp    35 <main+0x35>
    for (int i = 0; i < 3; i++)
  37:	bb 01 00 00 00       	mov    $0x1,%ebx
  3c:	8d 75 c4             	lea    -0x3c(%ebp),%esi
  3f:	90                   	nop
                getpinfo(&p);
  40:	83 ec 0c             	sub    $0xc,%esp
  43:	56                   	push   %esi
  44:	e8 40 03 00 00       	call   389 <getpinfo>
  ...
  52:	ff 75 d8             	pushl  -0x28(%ebp)
  55:	ff 75 d4             	pushl  -0x2c(%ebp)
  58:	ff 75 d0             	pushl  -0x30(%ebp)
  5b:	ff 75 cc             	pushl  -0x34(%ebp)
  5e:	ff 75 c8             	pushl  -0x38(%ebp)
  61:	ff 75 c4             	pushl  -0x3c(%ebp)
  64:	53                   	push   %ebx
  65:	68 c8 07 00 00       	push   $0x7c8
  6a:	6a 01                	push   $0x1
  6c:	e8 ef 03 00 00       	call   460 <printf>
                sleep(100);
  71:	83 c4 34             	add    $0x34,%esp
  74:	6a 64                	push   $0x64
  76:	e8 e6 02 00 00       	call   361 <sleep>
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	eb c0                	jmp    40 <main+0x40>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 24 08 00 00       	mov    $0x824,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 dc 0a 00 00       	mov    0xadc,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 dc 0a 00 00       	mov    %eax,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 774:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 777:	89 15 dc 0a 00 00    	mov    %edx,0xadc
}
 ...
 78f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 dc 0a 00 00 e0 	movl   $0xae0,0xadc
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf e0 0a 00 00       	mov    $0xae0,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
