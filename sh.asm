...
fork1(void)
{
  ...
  exit();
      ...
      c7:	68 d1 12 00 00       	push   $0x12d1
      cc:	6a 02                	push   $0x2
      ce:	e8 ed 0d 00 00       	call   ec0 <printf>
...
00000110 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     11e:	68 28 12 00 00       	push   $0x1228
     123:	6a 02                	push   $0x2
     125:	e8 96 0d 00 00       	call   ec0 <printf>
  memset(buf, 0, nbuf);
...
00000160 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	68 c5 12 00 00       	push   $0x12c5
     16e:	6a 02                	push   $0x2
     170:	e8 4b 0d 00 00       	call   ec0 <printf>
  exit();
...
00000180 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 e0 12 00 00 	jmp    *0x12e0(,%eax,4)
    if(pipe(p) < 0)
  ...
  if(pid == -1)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     23a:	68 32 12 00 00       	push   $0x1232
     23f:	6a 02                	push   $0x2
     241:	e8 7a 0c 00 00       	call   ec0 <printf>
    break;
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     29a:	68 2b 12 00 00       	push   $0x122b
     29f:	e8 bc fe ff ff       	call   160 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2a4:	52                   	push   %edx
     2a5:	ff 73 08             	pushl  0x8(%ebx)
     2a8:	68 42 12 00 00       	push   $0x1242
     2ad:	6a 02                	push   $0x2
     2af:	e8 0c 0c 00 00       	call   ec0 <printf>
      exit();
     2b4:	e8 78 0a 00 00       	call   d31 <exit>
      panic("pipe");
     2b9:	83 ec 0c             	sub    $0xc,%esp
     2bc:	68 57 12 00 00       	push   $0x1257
...
00000330 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     345:	68 52 12 00 00       	push   $0x1252
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     357:	6a 54                	push   $0x54
     359:	e8 c2 0d 00 00       	call   1120 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     387:	6a 18                	push   $0x18
     389:	e8 92 0d 00 00       	call   1120 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3d7:	6a 0c                	push   $0xc
     3d9:	e8 42 0d 00 00       	call   1120 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     417:	6a 0c                	push   $0xc
     419:	e8 02 0d 00 00       	call   1120 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     457:	6a 08                	push   $0x8
     459:	e8 c2 0c 00 00       	call   1120 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     489:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ad:	50                   	push   %eax
     4ae:	68 f0 18 00 00       	push   $0x18f0
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fd:	50                   	push   %eax
     4fe:	68 f0 18 00 00       	push   $0x18f0
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 e8 18 00 00       	push   $0x18e8
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 f0 18 00 00       	push   $0x18f0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 f0 18 00 00       	push   $0x18f0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 79 12 00 00       	push   $0x1279
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  return cmd;
     ...
     6fe:	68 5c 12 00 00       	push   $0x125c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     71f:	68 7c 12 00 00       	push   $0x127c
     724:	57                   	push   %edi
     725:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     76e:	68 93 12 00 00       	push   $0x1293
     773:	57                   	push   %edi
     774:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7b8:	68 85 12 00 00       	push   $0x1285
  ...
  cmd->eargv[argc] = 0;
     ...
     80a:	68 7e 12 00 00       	push   $0x127e
...
00000820 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     839:	68 98 12 00 00       	push   $0x1298
  cmd = parseexec(ps, es);
...
00000890 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 9a 12 00 00       	push   $0x129a
     8d0:	56                   	push   %esi
     8d1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 96 12 00 00       	push   $0x1296
     8e6:	56                   	push   %esi
     8e7:	53                   	push   %ebx
...
00000930 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     93f:	68 7c 12 00 00       	push   $0x127c
     944:	56                   	push   %esi
     945:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     969:	68 b8 12 00 00       	push   $0x12b8
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d5:	ff 24 85 f8 12 00 00 	jmp    *0x12f8(,%eax,4)
...
00000a70 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a97:	68 41 12 00 00       	push   $0x1241
     a9c:	53                   	push   %ebx
     a9d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     abf:	52                   	push   %edx
     ac0:	50                   	push   %eax
     ac1:	68 ba 12 00 00       	push   $0x12ba
     ac6:	6a 02                	push   $0x2
     ac8:	e8 f3 03 00 00       	call   ec0 <printf>
    panic("syntax");
     acd:	c7 04 24 7e 12 00 00 	movl   $0x127e,(%esp)
...
00000de1 <set_priority>:
SYSCALL(set_priority)
     de1:	b8 18 00 00 00       	mov    $0x18,%eax
     de6:	cd 40                	int    $0x40
     de8:	c3                   	ret    

00000de9 <getpinfo>:
     de9:	b8 19 00 00 00       	mov    $0x19,%eax
     dee:	cd 40                	int    $0x40
     df0:	c3                   	ret    
     df1:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
     e06:	89 d3                	mov    %edx,%ebx
{
     e08:	83 ec 3c             	sub    $0x3c,%esp
     e0b:	89 45 bc             	mov    %eax,-0x44(%ebp)
  if(sgn && xx < 0){
     e0e:	85 d2                	test   %edx,%edx
     e10:	0f 89 92 00 00 00    	jns    ea8 <printint+0xa8>
     e16:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
     e1a:	0f 84 88 00 00 00    	je     ea8 <printint+0xa8>
    neg = 1;
     e20:	c7 45 c0 01 00 00 00 	movl   $0x1,-0x40(%ebp)
    x = -xx;
     e27:	f7 db                	neg    %ebx
  } else {
    x = xx;
  ...
  i = 0;
     e29:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
     e30:	8d 75 d7             	lea    -0x29(%ebp),%esi
     e33:	eb 08                	jmp    e3d <printint+0x3d>
     e35:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
     e38:	89 7d c4             	mov    %edi,-0x3c(%ebp)
  }while((x /= base) != 0);
     e3b:	89 c3                	mov    %eax,%ebx
    buf[i++] = digits[x % base];
     e3d:	89 d8                	mov    %ebx,%eax
     e3f:	31 d2                	xor    %edx,%edx
     e41:	8b 7d c4             	mov    -0x3c(%ebp),%edi
     e44:	f7 f1                	div    %ecx
     e46:	83 c7 01             	add    $0x1,%edi
     e49:	0f b6 92 18 13 00 00 	movzbl 0x1318(%edx),%edx
     e50:	88 14 3e             	mov    %dl,(%esi,%edi,1)
  }while((x /= base) != 0);
     e53:	39 d9                	cmp    %ebx,%ecx
     e55:	76 e1                	jbe    e38 <printint+0x38>
  if(neg)
     e57:	8b 45 c0             	mov    -0x40(%ebp),%eax
     e5a:	85 c0                	test   %eax,%eax
     e5c:	74 0d                	je     e6b <printint+0x6b>
    buf[i++] = '-';
     e5e:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
     e63:	ba 2d 00 00 00       	mov    $0x2d,%edx
    buf[i++] = digits[x % base];
     e68:	89 7d c4             	mov    %edi,-0x3c(%ebp)
     e6b:	8b 45 c4             	mov    -0x3c(%ebp),%eax
     e6e:	8b 7d bc             	mov    -0x44(%ebp),%edi
     e71:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
     e75:	eb 0f                	jmp    e86 <printint+0x86>
     e77:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     e7e:	66 90                	xchg   %ax,%ax
     e80:	0f b6 13             	movzbl (%ebx),%edx
     e83:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
     e86:	83 ec 04             	sub    $0x4,%esp
     e89:	88 55 d7             	mov    %dl,-0x29(%ebp)
     e8c:	6a 01                	push   $0x1
     e8e:	56                   	push   %esi
     e8f:	57                   	push   %edi
     e90:	e8 bc fe ff ff       	call   d51 <write>

  while(--i >= 0)
     e95:	83 c4 10             	add    $0x10,%esp
     e98:	39 de                	cmp    %ebx,%esi
     e9a:	75 e4                	jne    e80 <printint+0x80>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
     ea8:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
     eaf:	e9 75 ff ff ff       	jmp    e29 <printint+0x29>
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     ecc:	0f b6 1e             	movzbl (%esi),%ebx
     ecf:	84 db                	test   %bl,%bl
     ed1:	0f 84 b9 00 00 00    	je     f90 <printf+0xd0>
  ap = (uint*)(void*)&fmt + 1;
     ed7:	8d 45 10             	lea    0x10(%ebp),%eax
     eda:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
     edd:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
     ee0:	31 d2                	xor    %edx,%edx
  ap = (uint*)(void*)&fmt + 1;
     ee2:	89 45 d0             	mov    %eax,-0x30(%ebp)
     ee5:	eb 38                	jmp    f1f <printf+0x5f>
     ee7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     eee:	66 90                	xchg   %ax,%ax
     ef0:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
     ef3:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
     ef8:	83 f8 25             	cmp    $0x25,%eax
     efb:	74 17                	je     f14 <printf+0x54>
  write(fd, &c, 1);
     efd:	83 ec 04             	sub    $0x4,%esp
     f00:	88 5d e7             	mov    %bl,-0x19(%ebp)
     f03:	6a 01                	push   $0x1
     f05:	57                   	push   %edi
     f06:	ff 75 08             	pushl  0x8(%ebp)
     f09:	e8 43 fe ff ff       	call   d51 <write>
     f0e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
     f11:	83 c4 10             	add    $0x10,%esp
     f14:	83 c6 01             	add    $0x1,%esi
  for(i = 0; fmt[i]; i++){
     f17:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
     f1b:	84 db                	test   %bl,%bl
     f1d:	74 71                	je     f90 <printf+0xd0>
    c = fmt[i] & 0xff;
     f1f:	0f be cb             	movsbl %bl,%ecx
     f22:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
     f25:	85 d2                	test   %edx,%edx
     f27:	74 c7                	je     ef0 <printf+0x30>
      }
    } else if(state == '%'){
     f29:	83 fa 25             	cmp    $0x25,%edx
     f2c:	75 e6                	jne    f14 <printf+0x54>
      if(c == 'd'){
     f2e:	83 f8 64             	cmp    $0x64,%eax
     f31:	0f 84 99 00 00 00    	je     fd0 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
     f37:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
     f3d:	83 f9 70             	cmp    $0x70,%ecx
     f40:	74 5e                	je     fa0 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
     f42:	83 f8 73             	cmp    $0x73,%eax
     f45:	0f 84 d5 00 00 00    	je     1020 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     f4b:	83 f8 63             	cmp    $0x63,%eax
     f4e:	0f 84 8c 00 00 00    	je     fe0 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
     f54:	83 f8 25             	cmp    $0x25,%eax
     f57:	0f 84 b3 00 00 00    	je     1010 <printf+0x150>
  write(fd, &c, 1);
     f5d:	83 ec 04             	sub    $0x4,%esp
     f60:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
     f64:	6a 01                	push   $0x1
     f66:	57                   	push   %edi
     f67:	ff 75 08             	pushl  0x8(%ebp)
     f6a:	e8 e2 fd ff ff       	call   d51 <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
     f6f:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
     f72:	83 c4 0c             	add    $0xc,%esp
     f75:	6a 01                	push   $0x1
     f77:	83 c6 01             	add    $0x1,%esi
     f7a:	57                   	push   %edi
     f7b:	ff 75 08             	pushl  0x8(%ebp)
     f7e:	e8 ce fd ff ff       	call   d51 <write>
  for(i = 0; fmt[i]; i++){
     f83:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
     f87:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
     f8a:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
     f8c:	84 db                	test   %bl,%bl
     f8e:	75 8f                	jne    f1f <printf+0x5f>
    }
  }
}
     ...
     fb0:	8b 13                	mov    (%ebx),%edx
     fb2:	e8 49 fe ff ff       	call   e00 <printint>
        ap++;
  ...
  write(fd, &c, 1);
     fe3:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
     fe6:	8b 03                	mov    (%ebx),%eax
  write(fd, &c, 1);
     fe8:	6a 01                	push   $0x1
        ap++;
     fea:	83 c3 04             	add    $0x4,%ebx
  write(fd, &c, 1);
     fed:	57                   	push   %edi
     fee:	ff 75 08             	pushl  0x8(%ebp)
        putc(fd, *ap);
     ff1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
     ff4:	e8 58 fd ff ff       	call   d51 <write>
        ap++;
     ff9:	89 5d d0             	mov    %ebx,-0x30(%ebp)
     ffc:	83 c4 10             	add    $0x10,%esp
      state = 0;
     fff:	31 d2                	xor    %edx,%edx
    1001:	e9 0e ff ff ff       	jmp    f14 <printf+0x54>
  ...
  write(fd, &c, 1);
    ...
    1016:	e9 5a ff ff ff       	jmp    f75 <printf+0xb5>
    101b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    101f:	90                   	nop
        s = (char*)*ap;
    1020:	8b 45 d0             	mov    -0x30(%ebp),%eax
    1023:	8b 18                	mov    (%eax),%ebx
        ap++;
    1025:	83 c0 04             	add    $0x4,%eax
    1028:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    102b:	85 db                	test   %ebx,%ebx
    102d:	74 17                	je     1046 <printf+0x186>
        while(*s != 0){
    102f:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    1032:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    1034:	84 c0                	test   %al,%al
    1036:	0f 84 d8 fe ff ff    	je     f14 <printf+0x54>
    103c:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    103f:	89 de                	mov    %ebx,%esi
    1041:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1044:	eb 1a                	jmp    1060 <printf+0x1a0>
          s = "(null)";
    1046:	bb 10 13 00 00       	mov    $0x1310,%ebx
        while(*s != 0){
    104b:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    104e:	b8 28 00 00 00       	mov    $0x28,%eax
    1053:	89 de                	mov    %ebx,%esi
    1055:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1058:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    105f:	90                   	nop
  write(fd, &c, 1);
    1060:	83 ec 04             	sub    $0x4,%esp
          s++;
    1063:	83 c6 01             	add    $0x1,%esi
    1066:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    1069:	6a 01                	push   $0x1
    106b:	57                   	push   %edi
    106c:	53                   	push   %ebx
    106d:	e8 df fc ff ff       	call   d51 <write>
        while(*s != 0){
    1072:	0f b6 06             	movzbl (%esi),%eax
    1075:	83 c4 10             	add    $0x10,%esp
    1078:	84 c0                	test   %al,%al
    107a:	75 e4                	jne    1060 <printf+0x1a0>
    107c:	8b 75 d4             	mov    -0x2c(%ebp),%esi
      state = 0;
    107f:	31 d2                	xor    %edx,%edx
    1081:	e9 8e fe ff ff       	jmp    f14 <printf+0x54>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1091:	a1 64 19 00 00       	mov    0x1964,%eax
{
    ...
    109e:	8b 10                	mov    (%eax),%edx
  bp = (Header*)ap - 1;
    10a0:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10a3:	39 c8                	cmp    %ecx,%eax
    10a5:	73 19                	jae    10c0 <free+0x30>
    10a7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    10ae:	66 90                	xchg   %ax,%ax
    10b0:	39 d1                	cmp    %edx,%ecx
    10b2:	72 14                	jb     10c8 <free+0x38>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10b4:	39 d0                	cmp    %edx,%eax
    10b6:	73 10                	jae    10c8 <free+0x38>
{
    10b8:	89 d0                	mov    %edx,%eax
    10ba:	8b 10                	mov    (%eax),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10bc:	39 c8                	cmp    %ecx,%eax
    10be:	72 f0                	jb     10b0 <free+0x20>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10c0:	39 d0                	cmp    %edx,%eax
    10c2:	72 f4                	jb     10b8 <free+0x28>
    10c4:	39 d1                	cmp    %edx,%ecx
    10c6:	73 f0                	jae    10b8 <free+0x28>
      break;
  if(bp + bp->s.size == p->s.ptr){
    10c8:	8b 73 fc             	mov    -0x4(%ebx),%esi
    10cb:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    10ce:	39 fa                	cmp    %edi,%edx
    10d0:	74 1e                	je     10f0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    10d2:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    10d5:	8b 50 04             	mov    0x4(%eax),%edx
    10d8:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    10db:	39 f1                	cmp    %esi,%ecx
    10dd:	74 28                	je     1107 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    10df:	89 08                	mov    %ecx,(%eax)
  freep = p;
}
    10e1:	5b                   	pop    %ebx
  freep = p;
    10e2:	a3 64 19 00 00       	mov    %eax,0x1964
}
    10e7:	5e                   	pop    %esi
    10e8:	5f                   	pop    %edi
    10e9:	5d                   	pop    %ebp
    ...
    10ef:	90                   	nop
    bp->s.size += p->s.ptr->s.size;
    10f0:	03 72 04             	add    0x4(%edx),%esi
    10f3:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    10f6:	8b 10                	mov    (%eax),%edx
    10f8:	8b 12                	mov    (%edx),%edx
    10fa:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    10fd:	8b 50 04             	mov    0x4(%eax),%edx
    1100:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    1103:	39 f1                	cmp    %esi,%ecx
    1105:	75 d8                	jne    10df <free+0x4f>
    p->s.size += bp->s.size;
    1107:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    110a:	a3 64 19 00 00       	mov    %eax,0x1964
    p->s.size += bp->s.size;
    110f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    1112:	8b 53 f8             	mov    -0x8(%ebx),%edx
    1115:	89 10                	mov    %edx,(%eax)
}
    1117:	5b                   	pop    %ebx
    1118:	5e                   	pop    %esi
    1119:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    112c:	8b 3d 64 19 00 00    	mov    0x1964,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    113d:	0f 84 ad 00 00 00    	je     11f0 <malloc+0xd0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    114a:	73 72                	jae    11be <malloc+0x9e>
    114c:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    1152:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1157:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    115a:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    1161:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1164:	eb 1b                	jmp    1181 <malloc+0x61>
    1166:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    116d:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1170:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1172:	8b 48 04             	mov    0x4(%eax),%ecx
    1175:	39 f1                	cmp    %esi,%ecx
    1177:	73 4f                	jae    11c8 <malloc+0xa8>
    1179:	8b 3d 64 19 00 00    	mov    0x1964,%edi
    ...
    if(p == freep)
    1181:	39 d7                	cmp    %edx,%edi
    1183:	75 eb                	jne    1170 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
    1185:	83 ec 0c             	sub    $0xc,%esp
    1188:	ff 75 e4             	pushl  -0x1c(%ebp)
    118b:	e8 29 fc ff ff       	call   db9 <sbrk>
  if(p == (char*)-1)
    1190:	83 c4 10             	add    $0x10,%esp
    1193:	83 f8 ff             	cmp    $0xffffffff,%eax
    1196:	74 1c                	je     11b4 <malloc+0x94>
  hp->s.size = nu;
    1198:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    119b:	83 ec 0c             	sub    $0xc,%esp
    119e:	83 c0 08             	add    $0x8,%eax
    11a1:	50                   	push   %eax
    11a2:	e8 e9 fe ff ff       	call   1090 <free>
  return freep;
    11a7:	8b 15 64 19 00 00    	mov    0x1964,%edx
      if((p = morecore(nunits)) == 0)
    11ad:	83 c4 10             	add    $0x10,%esp
    11b0:	85 d2                	test   %edx,%edx
    11b2:	75 bc                	jne    1170 <malloc+0x50>
        return 0;
  }
}
    11b4:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    11bd:	c3                   	ret    
    if(p->s.size >= nunits){
    11be:	89 d0                	mov    %edx,%eax
    11c0:	89 fa                	mov    %edi,%edx
    11c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    11c8:	39 ce                	cmp    %ecx,%esi
    11ca:	74 54                	je     1220 <malloc+0x100>
        p->s.size -= nunits;
    11cc:	29 f1                	sub    %esi,%ecx
    11ce:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    11d1:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    11d4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    ...
    11f7:	19 00 00 
    base.s.size = 0;
    11fa:	bf 68 19 00 00       	mov    $0x1968,%edi
    base.s.ptr = freep = prevp = &base;
    11ff:	c7 05 68 19 00 00 68 	movl   $0x1968,0x1968
    1206:	19 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1209:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    120b:	c7 05 6c 19 00 00 00 	movl   $0x0,0x196c
    1212:	00 00 00 
    if(p->s.size >= nunits){
    1215:	e9 32 ff ff ff       	jmp    114c <malloc+0x2c>
    121a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    1220:	8b 08                	mov    (%eax),%ecx
    1222:	89 0a                	mov    %ecx,(%edx)
    1224:	eb b1                	jmp    11d7 <malloc+0xb7>
