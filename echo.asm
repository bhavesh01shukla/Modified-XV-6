...
main(int argc, char *argv[])
{
  ...
  4f:	68 bf 07 00 00       	push   $0x7bf
  54:	50                   	push   %eax
  55:	68 ba 07 00 00       	push   $0x7ba
  5a:	6a 01                	push   $0x1
...
free(void *ap)
{
 ...
 621:	a1 78 0a 00 00       	mov    0xa78,%eax
{
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	8b 15 78 0a 00 00    	mov    0xa78,%edx
 ...
 764:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 767:	89 15 78 0a 00 00    	mov    %edx,0xa78
}
