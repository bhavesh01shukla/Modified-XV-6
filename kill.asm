 ...
 386:	89 d3                	mov    %edx,%ebx
{
 ...
 40e:	56                   	push   %esi
 40f:	57                   	push   %edi
 410:	e8 bc fe ff ff       	call   2d1 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 489:	e8 43 fe ff ff       	call   2d1 <write>
 ...
 4fe:	e8 ce fd ff ff       	call   2d1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 571:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 574:	e8 58 fd ff ff       	call   2d1 <write>
        ap++;
 ...
 5eb:	57                   	push   %edi
 5ec:	53                   	push   %ebx
 5ed:	e8 df fc ff ff       	call   2d1 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 74 0a 00 00       	mov    0xa74,%eax
{
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 74 0a 00 00    	mov    0xa74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	e8 29 fc ff ff       	call   339 <sbrk>
  if(p == (char*)-1)
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	8b 15 74 0a 00 00    	mov    0xa74,%edx
 ...
 754:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 757:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
